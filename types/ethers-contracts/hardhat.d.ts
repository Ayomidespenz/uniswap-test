...
getContractFactory(name: 'IUniSwap', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.IUniSwap__factory>
...
getContractAt(name: 'IUniSwap', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.IUniSwap>
...
deployContract(name: 'IUniSwap', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.IUniSwap>
...
deployContract(name: 'IUniSwap', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.IUniSwap>
